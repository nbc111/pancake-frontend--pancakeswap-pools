...
2. **检查返回结果**：
   ```
   如果 rewardToken = 0x5EaA2c6ae3bFf47D2188B64F743Ec777733a80ac
...
1. **切换到 BTC 代币合约**（地址：`0x5EaA2c6ae3bFf47D2188B64F743Ec777733a80ac`）
...
|--------|------|----------|------------|-------------|
| 1 | BTC | `0x5EaA2c6ae3bFf47D2188B64F743Ec777733a80ac` | `3941332303819498915` | `124293855533251717783440000` |
