...
export const MIXED_ROUTE_QUOTER_ADDRESSES = {
  ...
  [ChainId.NBC_CHAIN]: '0x0000000000000000000000000000000000000000', // 需要替换为实际的NBC Chain混合路由报价器地址
...
export const V3_QUOTER_ADDRESSES = {
  ...
  [ChainId.NBC_CHAIN]: '0x0000000000000000000000000000000000000000', // 需要替换为实际的NBC Chain V3报价器地址
} as const satisfies Record<ChainId, Address>
...
export const V3_TICK_LENS_ADDRESSES = {
  ...
  [ChainId.NBC_CHAIN]: '0x0000000000000000000000000000000000000000', // 需要替换为实际的NBC Chain Tick Lens地址
} as const satisfies Record<ChainId, Address>
