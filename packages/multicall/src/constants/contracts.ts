...
export const MULTICALL_ADDRESS: { [key in ChainId]?: Address } = {
  ...
  [ChainId.NBC_CHAIN]: '0xcA11bde05977b3631167028862bE2a173976CA11', // NBC Chain multicall3 address
}
...
export const MULTICALL3_ADDRESSES: {
  ...
  [ChainId.NBC_CHAIN]: MULTICALL3_ADDRESS, // NBC Chain multicall3 address
}
