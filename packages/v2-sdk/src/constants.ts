...
export const FACTORY_ADDRESS_MAP = {
  ...
  [ChainId.NBC_CHAIN]: '0x0000000000000000000000000000000000000000', // 需要替换为实际的NBC Chain工厂地址
...
export const INIT_CODE_HASH_MAP = {
  ...
  [ChainId.NBC_CHAIN]: '0x00fb7f630766e6a796048ea87d01acd3068e8ff67d078148a3fa3f4a84f69bd5', // 使用BSC的初始化代码哈希
