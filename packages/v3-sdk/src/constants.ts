...
export const FACTORY_ADDRESSES = {
  ...
  [ChainId.NBC_CHAIN]: '0x0000000000000000000000000000000000000000', // 需要替换为实际的NBC Chain V3工厂地址
...
export const DEPLOYER_ADDRESSES = {
  ...
  [ChainId.NBC_CHAIN]: '0x0000000000000000000000000000000000000000', // 需要替换为实际的NBC Chain V3部署者地址
} as const satisfies Record<ChainId, Address>
...
export const POOL_INIT_CODE_HASHES = {
  ...
  [ChainId.NBC_CHAIN]: '0x6ce8eb472fa82df5469c6ab6d485f17c3ad13c8cd7af59b3d4a8026c5ce0f7e2', // 使用标准的V3初始化代码哈希
...
export const NFT_POSITION_MANAGER_ADDRESSES = {
  ...
  [ChainId.NBC_CHAIN]: '0x0000000000000000000000000000000000000000', // 需要替换为实际的NBC Chain NFT位置管理器地址
} as const satisfies Record<ChainId, Address>
